...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['assignSubjectToSectionBtn'])) {
        ...
        if ($result->num_rows > 0) {
            // Subject is already assigned to this section
            header("Location: ../public/dashboard/instructor.php?error=Subject is already assigned to this section.");
            exit();
        }
